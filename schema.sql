...
VALUES ("Abimael", "Hernandez", "student", 1, " abimaelhernandez", "A6ppJ5z", "Hidalgo was the second-born child of Don Cristóbal Hidalgo y Costilla and Doña Ana María Gallaga Mandarte Villaseñor.[7] Hidalgo was born a criollo","6u5NqrKG3dA");
INSERT INTO profiles (first_name, last_name, role, cohort, github_link, picture_path, about_me, embeded_video)
VALUES ("Alejandro", "Rodriguez", "student", 1, "AlejandroRodriguezP", "XcvzwAI", "It became more than just learning code, when you work through at night with a peer beside you, that's when I realize we really are a family.","78ii7obZtQ4");
INSERT INTO profiles (first_name, last_name, role, cohort, github_link, picture_path, about_me, embeded_video)
VALUES ("Armando", "Cano", "student", 1, "armandocano91", "puks3Pr", "I knew always deep inside of me, that I was going to get the power to create something thanks to technology. Now, thanks to HolaCode I know how I'd like to grow as a professional, a software engineer, but most important of all, grow as a human being.","78ii7obZtQ4");
INSERT INTO profiles (first_name, last_name, role, cohort, github_link, picture_path, about_me, embeded_video)
VALUES ("Beatriz", "Garcia", "student", 1, "Beagbarreto", "25RYcRD", "Bicepresident","78ii7obZtQ4");
INSERT INTO profiles (first_name, last_name, role, cohort, github_link, picture_path, about_me, embeded_video)
VALUES ("Bruno", "Torres", "student", 1, "BrunoTorresF", "02nq7tM", "There are three things I love in this world: Mexico City, programming, and beer (not necessarily in that order). I’ve always loved technology so getting into programming was only a matter of time. Though, I only know JavaScript at the moment, I hope to learn a few other up-and-coming languages (Go, Rust, Dart).In my spare time, I like watching TV shows (British dramas and American sitcoms are the best), reading good sci-fi, and occasionally cooking.","78ii7obZtQ4");
INSERT INTO profiles (first_name, last_name, role, cohort, github_link, picture_path, about_me, embeded_video)
VALUES ("Cesar", "Tapia", "student", 1, "Cesar88Tapia", "5p4K9F9", "Love to break my head when hacking!!!!","78ii7obZtQ4");
INSERT INTO profiles (first_name, last_name, role, cohort, github_link, picture_path, about_me, embeded_video)
VALUES ("Edgar", "Muñoz", "student", 1, "edgarmunoz1", "mSse5Eh", "Student at <holaCode/> a software engineering school in CDMX, 'doing what I love' by Hacking obstacles and coding a happy future … OneLove!","78ii7obZtQ4");
INSERT INTO profiles (first_name, last_name, role, cohort, github_link, picture_path, about_me, embeded_video)
VALUES ("Eduardo", "Barranon", "student", 1, "Edward060290", "8BKlJgt", "Donald John Trump (born June 14, 1946) is the 45th and current President of the United States, in office since January 20, 2017. Before entering politics, he was a businessman and television personality.","78ii7obZtQ4");
INSERT INTO profiles (first_name, last_name, role, cohort, github_link, picture_path, about_me, embeded_video)
VALUES ("Eduardo", "Urrutia", "student", 1, "Eduardo091", "jVwRTYJ", "I like food","78ii7obZtQ4");
INSERT INTO profiles (first_name, last_name, role, cohort, github_link, picture_path, about_me, embeded_video)
VALUES ("Heber", "Gutierrez", "student", 1, "HeberGutierrez", "jxaNFiX", "Don't stop dreaming just because you had a nigthmare. Almost every successful person begins with two beliefs: the future can be better than the present, and i have the power to make it so.","78ii7obZtQ4");
INSERT INTO profiles (first_name, last_name, role, cohort, github_link, picture_path, about_me, embeded_video)
VALUES ("Jaqueline", "Lopez", "student", 1, "Jacqueline930", "1UTAvaD", "I Heart HolaCode. It gave me the opportunity of becoming a software engineer  by being someone I have identified since I have knowledge, a woman. HolaCode gave opened doors to be freely, ME, and to break all stereotypes, cliches for trans women.  I want to thank all staff and peers for being such open-minded, respectful, and lovely.","78ii7obZtQ4");
INSERT INTO profiles (first_name, last_name, role, cohort, github_link, picture_path, about_me, embeded_video)
...
INSERT INTO profiles (first_name, last_name, role, cohort, github_link, picture_path, about_me, embeded_video)
VALUES ("Jorge", "Cervantes", "student", 1, "JorgeC0218", "pUJlMvr", "Always keep your head held high","78ii7obZtQ4");
INSERT INTO profiles (first_name, last_name, role, cohort, github_link, picture_path, about_me, embeded_video)
VALUES ("Jorge", "Lerma", "student", 1, "jorgelerma", "frsg6wz", "Fidel Alejandro Castro Ruz August 13, 1926 – November 25, 2016) was a Cuban communist revolutionary and politician who governed the Republic of Cuba as Prime Minister.","78ii7obZtQ4");
INSERT INTO profiles (first_name, last_name, role, cohort, github_link, picture_path, about_me, embeded_video)
VALUES ("Joseph", "Fernandez", "student", 1, "JosephFernandez2689", "GjA2Drj", "Born in Mexico, raised in the States, New Yorker at heart. If I can help someone I will. I am relaxed and crazy. Sometimes I go out and drink with friends, really laid back, and  the New Yorker comes out hahah . I live life ... live it good we are not suppose to give it back in-tact. There is always something to learn.","78ii7obZtQ4");
INSERT INTO profiles (first_name, last_name, role, cohort, github_link, picture_path, about_me, embeded_video)
VALUES ("Juan", "Tejada", "student", 1, "Johntejeda", "arqm7oP", "Santa Anna was a member of the same tribe of the Comanche as the more famous Buffalo Hump.","78ii7obZtQ4");
INSERT INTO profiles (first_name, last_name, role, cohort, github_link, picture_path, about_me, embeded_video)
VALUES ("Luis", "Avila", "student", 1, "Lalolalo85", "mYEVQv1", "I´m outgoing, like to try out new things, funny, laid back, if you know me then u know me.","78ii7obZtQ4");
INSERT INTO profiles (first_name, last_name, role, cohort, github_link, picture_path, about_me, embeded_video)
VALUES ("Luis Gerardo", "Nava", "student", 1, "luisgnava", "rvaeR5F", "'The present is theirs, the future for which I really worked is mine'","78ii7obZtQ4");
INSERT INTO profiles (first_name, last_name, role, cohort, github_link, picture_path, about_me, embeded_video)
VALUES ("Luis", "Ortiz", "student", 1, "Luisortizlopez", "PSyVaYL", "Enrique Peña Nieto born 20 July 1966),[1] sometimes referred to by his initials EPN,[2] is a Mexican politician serving as the 57th and current President of Mexico.","78ii7obZtQ4");
INSERT INTO profiles (first_name, last_name, role, cohort, github_link, picture_path, about_me, embeded_video)
VALUES ("Marco", "Castillo", "student", 1, "marcocastillo2506", "LK9uEa2", "If you want to destroy any nation without a war , coding is your sword","78ii7obZtQ4");
INSERT INTO profiles (first_name, last_name, role, cohort, github_link, picture_path, about_me, embeded_video)
...
INSERT INTO profiles (first_name, last_name, role, cohort, github_link, picture_path, about_me, embeded_video)
VALUES ("Ricardo", "Varona", "student", 1, "Varonss", "yUfGNbd", "My name is Richie from CDMX, I'm a father of 2 kiddos and a husband. I´ve done high school back in Manchester, TN. I like sports, movies, listening to music, playing chess, and be able to help out people in so many different ways.","78ii7obZtQ4");
INSERT INTO profiles (first_name, last_name, role, cohort, github_link, picture_path, about_me, embeded_video)
