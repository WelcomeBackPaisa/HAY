...
INSERT INTO profiles (first_name, last_name, role, cohort, github_link, picture_path, about_me, embeded_video)
VALUES ("Juan", "Tejada", "student", 1, "Johntejeda", "arqm7oP", "Santa Anna was a member of the same tribe of the Comanche as the more famous Buffalo Hump.","embed/9-ogX10MT9g");
INSERT INTO profiles (first_name, last_name, role, cohort, github_link, picture_path, about_me, embeded_video)
